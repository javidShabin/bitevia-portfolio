...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  const renderTag = () => {
    ...
    switch (tag) {
      ...
      case "h5":
        return <h5 ref={ref as React.RefObject<HTMLHeadingElement>} style={style} className={classes}>{text}</h5>;
      case "h6":
        return <h6 ref={ref as React.RefObject<HTMLHeadingElement>} style={style} className={classes}>{text}</h6>;
      default:
